...
//            category_name and tag ak sate kaj korbe na
//            "category_name"=>'more-info',
//            'tag'=>'special',
    //category tag aksate chaihile tax_query use korte hbe
//        'tax_query' => array(
//                'relation' => 'or',
//                array(
...
//	                        "post-format-video"
//                        ),
////                    'operator' => 'NOT IN'//operer audio,video term 2ta na chaile
//                )
//
//        ),
    // single meta_key & meta_value diye search
            'meta_key' => 'featured',
            'meta_value' => '1',
        // multiple meta_key & meta_value diye search
            'meta_query' => array(
                    'relation' => 'AND',
                    array(
                            'key' => 'featured',
